export const carouselSlidesData = [
  ...
  {
  	id:4,
  	content:"What started as a strategy session became a trusted advisor relationship.Dan has an ability to keep us focused on the important issues by keeping everyone accountable.  He is a collaborator that makes the team feel comfortable with him as we continue to change and improve.",
